...
<head>
    ...
    <title>Tournament Manager Info</title>
...
<body>
    <?php
        ...
        if(isset($_POST["save"])){
            ...
            $sql = "SELECT * FROM tournamentmanager WHERE userName=$userName";
            $result = mysqli_query($con, $sql);

            if(mysqli_num_rows($result) === 0){
                $sql = "INSERT INTO `tournamentmanager`(`userName`,`fName`, `lName`, `mobile`, `deptID`) VALUES ($userName,'$fname','$lname',$mobile,$deptID)";
    ...
    <div class="container">
        <h1>Your Info</h1>
        <form method="POST" action="tournamentManagerInfo.php">
